...
public class RequestGetServlet extends HttpServlet {
	...
	*/
	...
	//장점 : java코드 내에 작성하지 때문에 반복문이나 조건문, 유용한 메소드같은 것들을 활용하여 동적인 응답을 내릴 수 있다.
	//단점 : 불편, 복잡, 혹시라도 차후에 html을 수정한다면 java코드를 수정하는것이기 때문에 수정된 내용을 다시 반영시키고자
	// 		서버를 재실행 해야된다.
	...
	//3)위에서 가져온 스트림을 통해서 응답 html구문을 한줄씩 출력
	out.println("<html>");
